...
if __name__ == '__main__':
    ...
    set_num = 1
    if not os.path.exists(f'eval/mle/{dataname}_{set_num}'):
        os.makedirs(f'eval/mle/{dataname}_{set_num}')
    
    csv_path = os.path.split(train_path)[1]
    csv_name = csv_path.split('.')[0]
    save_path = f'eval/mle/{dataname}_{set_num}/' + csv_name + '.json'
